...
| `knowledge/domain/products.md` | Need product types, xAPI fields, test data |
| `knowledge/domain/sitemap.md` | Need page URLs for navigation |
| `knowledge/domain/store-settings.md` | Need store configuration details |
