...
> |---|---|---|
> | What | The bug-lifecycle slice: setup, bug filing, autofix, verification, monitoring, self-diagnostics (8 agents / 16 skills / 8 commands). | The whole crew: regression, BA analysis, ~110 reference suites, test-data + authoring framework (19 agents / 39 skills / 30 commands). |
