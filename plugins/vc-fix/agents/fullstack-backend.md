...
applicability_rationale: ".NET 10 + Angular + xUnit/Jasmine + local git/gh workflow against vc-module-* repos. Universal across VC customers; repo allowlist is data (skills/qa-fix-routing/fix-repos.json)."
---
