...
Resolve the **exact** module name via `knowledge/execution/module-suite-map.md` (Module → REST path →
...
| Admin SPA section | Check `knowledge/execution/module-suite-map.md` |
