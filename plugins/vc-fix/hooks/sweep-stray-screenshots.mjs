...
try {
  // NOT derived from import.meta.url: the plugin is installed outside the
  // project, so its own location says nothing about where strays land.
  ...
  let dest = join(root, "reports", "_stray-screenshots");
  try {
