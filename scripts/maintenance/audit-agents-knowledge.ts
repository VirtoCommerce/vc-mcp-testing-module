...
const CLASSIFICATIONS: Classification[] = [
  // QA agents (10)
  { path: ".claude/agents/qa-lead-orchestrator.md", category: "agent-qa", applicability: "universal",
  ...
  { path: ".claude/agents/qa-frontend-expert.md", category: "agent-qa", applicability: "reference",
  ...
  { path: ".claude/agents/qa-backend-expert.md", category: "agent-qa", applicability: "reference",
  ...
  { path: ".claude/agents/qa-testing-expert.md", category: "agent-qa", applicability: "universal",
  ...
  { path: ".claude/agents/test-management-specialist.md", category: "agent-qa", applicability: "universal",
  ...
  { path: ".claude/agents/ui-ux-expert.md", category: "agent-qa", applicability: "reference",
  ...
  { path: ".claude/agents/ba-api-specialist.md", category: "agent-ba", applicability: "universal",
    rationale: "Postman / Swagger / GitHub MCP for VC API analysis. Universal." },
  { path: ".claude/agents/ba-story-writer.md", category: "agent-ba", applicability: "universal",
    rationale: "Agile user stories + BDD acceptance criteria. Pure craft, no VC-specific assumptions." },
  { path: ".claude/agents/ba-doc-writer.md", category: "agent-ba", applicability: "universal",
  ...
  { path: ".claude/knowledge/execution/live-discovery.md", category: "knowledge", applicability: "universal",
