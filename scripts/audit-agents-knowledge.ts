...
const CLASSIFICATIONS: Classification[] = [
  ...
  // Knowledge files (26)
  { path: ".claude/agents/knowledge/api/api-auth.md", category: "knowledge", applicability: "universal",
    rationale: "VC platform OAuth2 token endpoint pattern. Same for every VC deployment." },
  { path: ".claude/agents/knowledge/automation/browser-quirks.md", category: "knowledge", applicability: "universal",
    rationale: "Per-browser rendering differences. Cross-VC universal." },
  { path: ".claude/agents/knowledge/oracles/business-logic.md", category: "knowledge", applicability: "reference",
  ...
  { path: ".claude/agents/knowledge/domain/catalog.md", category: "knowledge", applicability: "reference",
    rationale: "Storefront catalog reference — assumes vcst's catalog structure. Customer adapts." },
  { path: ".claude/agents/knowledge/oracles/critical-ui-scope.md", category: "knowledge", applicability: "reference",
    rationale: "vcst's 7 components × 8 pages coverage matrix. Customer adapts to their components/pages." },
  { path: ".claude/agents/knowledge/execution/debugging-signals.md", category: "knowledge", applicability: "universal",
    rationale: "Console + network debugging heuristics. Cross-VC universal." },
  { path: ".claude/agents/knowledge/oracles/e-commerce-edge-cases-library.md", category: "knowledge", applicability: "reference",
  ...
  { path: ".claude/agents/knowledge/api/graphiql-interaction.md", category: "knowledge", applicability: "universal",
    rationale: "GraphiQL UI interaction guide — CodeMirror editor steps. Universal across VC deployments." },
  { path: ".claude/agents/knowledge/api/graphql-schema.md", category: "knowledge", applicability: "reference",
  ...
  { path: ".claude/agents/knowledge/api/graphql-test-cases-runner.md", category: "knowledge", applicability: "universal",
    rationale: "Runner contract grammar (tag syntax, predicate shapes, @td()/{{VAR}} forms). Format spec, universal." },
  { path: ".claude/agents/knowledge/execution/live-discovery.md", category: "knowledge", applicability: "universal",
  ...
  { path: ".claude/agents/knowledge/execution/module-suite-map.md", category: "knowledge", applicability: "reference",
    rationale: "vcst's module → suite mapping. Customer's mapping differs by module set + custom suites." },
  { path: ".claude/agents/knowledge/api/order-creation-matrix.md", category: "knowledge", applicability: "reference",
    rationale: "vcst's payment + shipping combinations matrix. Customer's processor + shipping set differs." },
  { path: ".claude/agents/knowledge/execution/performance-thresholds.md", category: "knowledge", applicability: "universal",
    rationale: "Web Vitals + LCP/CLS/TTI budgets. Cross-app universal." },
  { path: ".claude/agents/knowledge/api/platform-patterns.md", category: "knowledge", applicability: "universal",
    rationale: "VC platform architecture patterns. Same for every VC deployment." },
  { path: ".claude/agents/knowledge/domain/products.md", category: "knowledge", applicability: "reference",
    rationale: "Storefront product types + xAPI fields. Customer's products differ; pattern reusable." },
  { path: ".claude/agents/knowledge/domain/sitemap.md", category: "knowledge", applicability: "reference",
  ...
  { path: ".claude/agents/knowledge/domain/store-settings.md", category: "knowledge", applicability: "reference",
    rationale: "Storefront store config patterns. Customer's settings differ." },
  { path: ".claude/agents/knowledge/automation/storefront-config-flags.md", category: "knowledge", applicability: "reference",
  ...
  { path: ".claude/agents/knowledge/automation/storefront-selectors.md", category: "knowledge", applicability: "reference",
    rationale: "vc-frontend stable selectors (data-test-id / role / aria-label). Customer with custom theme adapts selector strategy." },
  { path: ".claude/agents/knowledge/execution/test-execution-preflight.md", category: "knowledge", applicability: "universal",
    rationale: "Pre-run readiness checklist (env health, fixture seed, MCP status). Universal." },
  { path: ".claude/agents/knowledge/execution/test-runner-tags.md", category: "knowledge", applicability: "universal",
    rationale: "CSV column / step / assertion tag reference. Format spec, universal." },
  { path: ".claude/agents/knowledge/oracles/vc-bug-catalog.md", category: "knowledge", applicability: "reference",
  ...
  { path: ".claude/agents/knowledge/architecture/vc-module-architecture.md", category: "knowledge", applicability: "reference",
  ...
  { path: ".claude/agents/knowledge/architecture/vc-frontend-architecture.md", category: "knowledge", applicability: "reference",
  ...
  { path: ".claude/agents/knowledge/domain/white-labeling.md", category: "knowledge", applicability: "reference",
