...
const CLASSIFICATIONS: Classification[] = [
  // QA agents (10)
  { path: "agents/qa-lead-orchestrator.md", category: "agent-qa", applicability: "universal",
  ...
  { path: "agents/qa-frontend-expert.md", category: "agent-qa", applicability: "reference",
  ...
  { path: "agents/qa-backend-expert.md", category: "agent-qa", applicability: "reference",
  ...
  { path: "agents/qa-testing-expert.md", category: "agent-qa", applicability: "universal",
  ...
  { path: "agents/test-management-specialist.md", category: "agent-qa", applicability: "universal",
  ...
  { path: "agents/ui-ux-expert.md", category: "agent-qa", applicability: "reference",
  ...
  { path: "knowledge/agents/ba/shared-instructions.md", category: "agent-shared", applicability: "universal",
  ...
  { path: "knowledge/agents/developers/shared-instructions.md", category: "agent-shared", applicability: "reference",
  ...
  // BA agents (4)
  { path: "agents/ba-system-analyzer.md", category: "agent-ba", applicability: "universal",
  ...
  { path: "agents/ba-api-specialist.md", category: "agent-ba", applicability: "universal",
    rationale: "Postman / Swagger / GitHub MCP for VC API analysis. Universal." },
  { path: "agents/ba-story-writer.md", category: "agent-ba", applicability: "universal",
    rationale: "Agile user stories + BDD acceptance criteria. Pure craft, no VC-specific assumptions." },
  { path: "agents/ba-doc-writer.md", category: "agent-ba", applicability: "universal",
    rationale: "User-facing docs + admin guides. Pure docs craft." },

  // Developers agents (4) — the only write-capable team, used by /qa-fix
  { path: "agents/fullstack-backend.md", category: "agent-dev", applicability: "universal",
  ...
  { path: "agents/backend-reviewer.md", category: "agent-dev", applicability: "universal",
    rationale: "C#/Angular Gate-4 review discipline against VC business invariants + .NET 10 best practices. Universal." },
  { path: "agents/fullstack-frontend.md", category: "agent-dev", applicability: "universal",
  ...
  { path: "agents/frontend-reviewer.md", category: "agent-dev", applicability: "universal",
    rationale: "Vue 3 / TS Gate-4 review discipline against BL-UI invariants + Vue 3 best practices. Universal." },

  // Knowledge files (26)
  { path: "knowledge/api/api-auth.md", category: "knowledge", applicability: "universal",
    rationale: "VC platform OAuth2 token endpoint pattern. Same for every VC deployment." },
  { path: "knowledge/automation/browser-quirks.md", category: "knowledge", applicability: "universal",
    rationale: "Per-browser rendering differences. Cross-VC universal." },
  { path: "knowledge/oracles/business-logic.md", category: "knowledge", applicability: "reference",
  ...
  { path: "knowledge/domain/catalog.md", category: "knowledge", applicability: "reference",
    rationale: "Storefront catalog reference — assumes vcst's catalog structure. Customer adapts." },
  { path: "knowledge/oracles/critical-ui-scope.md", category: "knowledge", applicability: "reference",
    rationale: "vcst's 7 components × 8 pages coverage matrix. Customer adapts to their components/pages." },
  { path: "knowledge/execution/debugging-signals.md", category: "knowledge", applicability: "universal",
    rationale: "Console + network debugging heuristics. Cross-VC universal." },
  { path: "knowledge/oracles/e-commerce-edge-cases-library.md", category: "knowledge", applicability: "reference",
  ...
  { path: "knowledge/api/graphiql-interaction.md", category: "knowledge", applicability: "universal",
    rationale: "GraphiQL UI interaction guide — CodeMirror editor steps. Universal across VC deployments." },
  { path: "knowledge/api/graphql-schema.md", category: "knowledge", applicability: "reference",
  ...
  { path: "knowledge/api/graphql-test-cases-runner.md", category: "knowledge", applicability: "universal",
    rationale: "Runner contract grammar (tag syntax, predicate shapes, @td()/{{VAR}} forms). Format spec, universal." },
  { path: "knowledge/execution/live-discovery.md", category: "knowledge", applicability: "universal",
  ...
  { path: "knowledge/execution/module-suite-map.md", category: "knowledge", applicability: "reference",
    rationale: "vcst's module → suite mapping. Customer's mapping differs by module set + custom suites." },
  { path: "knowledge/api/order-creation-matrix.md", category: "knowledge", applicability: "reference",
    rationale: "vcst's payment + shipping combinations matrix. Customer's processor + shipping set differs." },
  { path: "knowledge/execution/performance-thresholds.md", category: "knowledge", applicability: "universal",
    rationale: "Web Vitals + LCP/CLS/TTI budgets. Cross-app universal." },
  { path: "knowledge/api/platform-patterns.md", category: "knowledge", applicability: "universal",
    rationale: "VC platform architecture patterns. Same for every VC deployment." },
  { path: "knowledge/domain/products.md", category: "knowledge", applicability: "reference",
    rationale: "Storefront product types + xAPI fields. Customer's products differ; pattern reusable." },
  { path: "knowledge/domain/sitemap.md", category: "knowledge", applicability: "reference",
  ...
  { path: "knowledge/domain/store-settings.md", category: "knowledge", applicability: "reference",
    rationale: "Storefront store config patterns. Customer's settings differ." },
  { path: "knowledge/automation/storefront-config-flags.md", category: "knowledge", applicability: "reference",
  ...
  { path: "knowledge/automation/storefront-selectors.md", category: "knowledge", applicability: "reference",
    rationale: "vc-frontend stable selectors (data-test-id / role / aria-label). Customer with custom theme adapts selector strategy." },
  { path: "knowledge/execution/test-execution-preflight.md", category: "knowledge", applicability: "universal",
    rationale: "Pre-run readiness checklist (env health, fixture seed, MCP status). Universal." },
  { path: "knowledge/execution/test-runner-tags.md", category: "knowledge", applicability: "universal",
    rationale: "CSV column / step / assertion tag reference. Format spec, universal." },
  { path: "knowledge/oracles/vc-bug-catalog.md", category: "knowledge", applicability: "reference",
  ...
  { path: "knowledge/architecture/vc-module-architecture.md", category: "knowledge", applicability: "reference",
  ...
  { path: "knowledge/architecture/vc-frontend-architecture.md", category: "knowledge", applicability: "reference",
  ...
  { path: "knowledge/domain/white-labeling.md", category: "knowledge", applicability: "reference",
