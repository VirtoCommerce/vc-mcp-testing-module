...
Authoring guides:
- Browser-mode CSV tags: [`.claude/agents/knowledge/execution/test-runner-tags.md`](../../.claude/agents/knowledge/execution/test-runner-tags.md)
- Runner-native GraphQL cases: [`.claude/agents/knowledge/api/graphql-test-cases-runner.md`](../../.claude/agents/knowledge/api/graphql-test-cases-runner.md)
...
- [module-suite-map.md](../../.claude/agents/knowledge/execution/module-suite-map.md) — Module-to-suite mapping
