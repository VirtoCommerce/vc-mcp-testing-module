...
### purchase-flow (10 suites, ~644 cases)
...
| 04c | [Orders & Quotes Tests](Frontend/04c-orders-quotes-tests.csv) | frontend | functional | 35 | P1 |
...
| 19 | [Pricing Admin Tests](Backend/19-pricing-tests.csv) | backend | admin | 64 | P1 |
| 20 | [Orders Admin Tests](Backend/20-orders-tests.csv) | backend | admin | 80 | P1 |
| 22 | [Inventory Admin Tests](Backend/22-inventory-tests.csv) | backend | admin | 43 | P1 |
| 30 | [Shipping Module Tests](Backend/30-shipping-tests.csv) | backend | admin | 15 | P1 |
| 37 | [Returns Admin Tests](Backend/37-returns-tests.csv) | backend | admin | 22 | P1 |

### catalog-search (5 suites, ~370 cases)
Product discovery: catalog, search, configurable products, indexing, import/export.

| # | Suite | Layer | Concern | Cases | Priority |
|---|-------|-------|---------|-------|----------|
| 03 | [Catalog & Search Tests](Frontend/03-catalog-search-tests.csv) | frontend | functional | 121 | P1 |
| 36 | [Configurable Products Tests](Frontend/36-configurable-products-tests.csv) | frontend | functional | 133 | P1 |
| 16 | [Catalog Admin Tests](Backend/16-catalog-tests.csv) | backend | admin | 48 | P1 |
| 26 | [Search & Indexing Tests](Backend/26-search-indexing-tests.csv) | backend | admin | 40 | P1 |
| 29 | [CSV Export Import Tests](Backend/29-csv-export-import-tests.csv) | backend | admin | 18 | P1 |

### auth-security (4 suites, ~188 cases)
Authentication, authorization, platform API, and security.

| # | Suite | Layer | Concern | Cases | Priority |
|---|-------|-------|---------|-------|----------|
| 02 | [Authentication Tests](Frontend/02-authentication-tests.csv) | frontend | functional | 61 | P1 |
| 08 | [Security Tests](Frontend/08-security-tests.csv) | frontend | functional | 30 | P0 |
| 14 | [Platform API Tests](Backend/14-platform-api-tests.csv) | backend | api | 32 | P0 |
| 17 | [Platform Core Tests](Backend/17-platform-core-tests.csv) | backend | admin | 65 | P1 |

### marketing (3 suites, ~166 cases)
...
| 23 | [Marketing Admin Tests](Backend/23-marketing-tests.csv) | backend | admin | 74 | P1 |
| 42 | [xMarketing Module Tests](Backend/42-xmarketing-tests.csv) | backend | admin | 38 | P1 |

### customer-b2b (4 suites, ~204 cases)
Customer management, B2C features, contracts, loyalty.

| # | Suite | Layer | Concern | Cases | Priority |
|---|-------|-------|---------|-------|----------|
| 13 | [B2C Features Tests](Frontend/13-b2c-features-tests.csv) | frontend | functional | 96 | P1 |
| 21 | [Customer Admin Tests](Backend/21-customer-tests.csv) | backend | admin | 72 | P1 |
...
### platform-config (4 suites, ~123 cases)
GraphQL xAPI, store configuration, core settings, channels.

| # | Suite | Layer | Concern | Cases | Priority |
|---|-------|-------|---------|-------|----------|
| 15 | [GraphQL xAPI Tests](Backend/15-graphql-xapi-tests.csv) | backend | api | 29 | P1 |
...
### content-cms (3 suites, ~99 cases)
CMS, page builder, assets, image tools.

| # | Suite | Layer | Concern | Cases | Priority |
|---|-------|-------|---------|-------|----------|
| 25 | [CMS & Page Builder Tests](Backend/25-cms-pagebuilder-tests.csv) | backend | admin | 55 | P1 |
| 27 | [Assets Module Tests](Backend/27-assets-tests.csv) | backend | admin | 24 | P1 |
| 34 | [Image Tools Tests](Backend/34-image-tools-tests.csv) | backend | admin | 20 | P2 |

### branding (3 suites, ~103 cases)
...
| 32 | [White Labeling Tests](Backend/32-whitelabeling-tests.csv) | backend | admin | 15 | P2 |

### communication (2 suites, ~77 cases)
Notifications and push messages.

| # | Suite | Layer | Concern | Cases | Priority |
|---|-------|-------|---------|-------|----------|
| 24 | [Notifications Admin Tests](Backend/24-notifications-tests.csv) | backend | admin | 52 | P1 |
| 33 | [Push Messages Tests](Backend/33-push-messages-tests.csv) | backend | admin | 25 | P2 |

### cross-cutting (7 suites, ~218 cases)
Smoke, analytics, accessibility, localization, performance, browser compatibility, master suite.

| # | Suite | Layer | Concern | Cases | Priority |
|---|-------|-------|---------|-------|----------|
| 00 | [Full Regression Release](Frontend/00-full-regression-release.csv) | frontend | functional | 90 | P0 |
...
| 10 | [Localization Tests](Frontend/10-localization-tests.csv) | frontend | non-functional | 21 | P2 |
...
|---|------|-------|----------|--------|
| 00 | [00-full-regression-release.csv](Frontend/00-full-regression-release.csv) | 90 | P0 | cross-cutting |
| 01 | [01-smoke-tests.csv](Frontend/01-smoke-tests.csv) | 19 | P0 | cross-cutting |
| 02 | [02-authentication-tests.csv](Frontend/02-authentication-tests.csv) | 61 | P1 | auth-security |
| 03 | [03-catalog-search-tests.csv](Frontend/03-catalog-search-tests.csv) | 121 | P1 | catalog-search |
...
| 04c | [04c-orders-quotes-tests.csv](Frontend/04c-orders-quotes-tests.csv) | 35 | P1 | purchase-flow |
...
| 08 | [08-security-tests.csv](Frontend/08-security-tests.csv) | 30 | P0 | auth-security |
| 09 | [09-accessibility-tests.csv](Frontend/09-accessibility-tests.csv) | 23 | P1 | cross-cutting |
| 10 | [10-localization-tests.csv](Frontend/10-localization-tests.csv) | 21 | P2 | cross-cutting |
...
| 13 | [13-b2c-features-tests.csv](Frontend/13-b2c-features-tests.csv) | 96 | P1 | customer-b2b |
...
| # | File | Cases | Priority | Domain |
|---|------|-------|----------|--------|
| 14 | [14-platform-api-tests.csv](Backend/14-platform-api-tests.csv) | 32 | P0 | auth-security |
| 15 | [15-graphql-xapi-tests.csv](Backend/15-graphql-xapi-tests.csv) | 29 | P1 | platform-config |
| 16 | [16-catalog-tests.csv](Backend/16-catalog-tests.csv) | 48 | P1 | catalog-search |
| 17 | [17-platform-core-tests.csv](Backend/17-platform-core-tests.csv) | 65 | P1 | auth-security |
| 18 | [18-store-tests.csv](Backend/18-store-tests.csv) | 65 | P1 | platform-config |
| 19 | [19-pricing-tests.csv](Backend/19-pricing-tests.csv) | 64 | P1 | purchase-flow |
| 20 | [20-orders-tests.csv](Backend/20-orders-tests.csv) | 80 | P1 | purchase-flow |
| 21 | [21-customer-tests.csv](Backend/21-customer-tests.csv) | 72 | P1 | customer-b2b |
| 22 | [22-inventory-tests.csv](Backend/22-inventory-tests.csv) | 43 | P1 | purchase-flow |
| 23 | [23-marketing-tests.csv](Backend/23-marketing-tests.csv) | 74 | P1 | marketing |
| 24 | [24-notifications-tests.csv](Backend/24-notifications-tests.csv) | 52 | P1 | communication |
| 25 | [25-cms-pagebuilder-tests.csv](Backend/25-cms-pagebuilder-tests.csv) | 55 | P1 | content-cms |
| 26 | [26-search-indexing-tests.csv](Backend/26-search-indexing-tests.csv) | 40 | P1 | catalog-search |
...
| 30 | [30-shipping-tests.csv](Backend/30-shipping-tests.csv) | 15 | P1 | purchase-flow |
| 31 | [31-seo-tests.csv](Backend/31-seo-tests.csv) | 20 | P1 | branding |
| 32 | [32-whitelabeling-tests.csv](Backend/32-whitelabeling-tests.csv) | 15 | P2 | branding |
| 33 | [33-push-messages-tests.csv](Backend/33-push-messages-tests.csv) | 25 | P2 | communication |
| 34 | [34-image-tools-tests.csv](Backend/34-image-tools-tests.csv) | 20 | P2 | content-cms |
