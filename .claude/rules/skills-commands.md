...
| `/qa-checklist` | `domain \| feature \| VCST-XXXX \| new <domain> \| admin <module>` | Test case writing checklists (62 domains: 32 storefront + 29 backend/admin + 1 GraphQL, 696 items) | `domain-checklists.md`, `backend-admin-checklists.md`, `graphql-checklist.md`, `checklist-creation-guide.md` |
