...
| `/qa-checklist` | `domain \| feature \| VCST-XXXX \| new <domain> \| admin <module>` | Test case writing checklists (63 domains: 33 storefront + 29 backend/admin + 1 GraphQL, 716 items) | `domain-checklists.md`, `backend-admin-checklists.md`, `graphql-checklist.md`, `checklist-creation-guide.md` |
