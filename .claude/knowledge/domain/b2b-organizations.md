...
| **G15** | Canonical role → permission mapping for the shipped org roles | **OPEN.** No doc states which permissions `Organization maintainer` / `Purchasing agent` / `Organization employee` carry on any env |
