...
> `.claude/knowledge/domain/` (6) · `reports/tickets/` (0 runs)
...
- **Prior BA analysis** (9): [`vcst-5735-compare-products-customer-guide.md`](../../../reports/ba/vcst-5735-compare-products-customer-guide.md) *(2026-09-07)* · [`catalog-binary-sidecars.md`](../../../reports/ba/Backup-Restore/catalog-binary-sidecars.md) *(2026-08-20)* · [`BA-REPORT-configurable-products-sorting.md`](../../../reports/ba/Configurable products/BA-REPORT-configurable-products-sorting.md) *(2026-08-10)* · [`ba-report-VCST-4713-conditional-sections.md`](../../../reports/ba/Configurable products/ba-report-VCST-4713-conditional-sections.md) *(2026-08-10)* · [`ba-report-VCST-4806-maxlength-validation.md`](../../../reports/ba/Configurable products/ba-report-VCST-4806-maxlength-validation.md) *(2026-08-10)* · [`ba-report-VCST-4928-character-counter-docs.md`](../../../reports/ba/Configurable products/ba-report-VCST-4928-character-counter-docs.md) *(2026-08-10)* · [`conditional-sections-admin-guide.md`](../../../reports/ba/Configurable products/conditional-sections-admin-guide.md) *(2026-08-10)* · [`conditional-sections-storefront-behavior.md`](../../../reports/ba/Configurable products/conditional-sections-storefront-behavior.md) *(2026-08-10)* · [`order-history-filter-persistence-stories.md`](../../../reports/ba/order-history-filter-persistence-stories.md) *(2026-08-10)*
...
- **Domain knowledge**: none
- **Prior BA analysis** (1): [`catalog-binary-sidecars.md`](../../../reports/ba/Backup-Restore/catalog-binary-sidecars.md) *(2026-08-20)*
- **Prior test models** (0): none — the first FULL run on this domain writes one
- **Already tested here** (0): no run has verified a BL in this domain
...
- **Domain knowledge**: none
- **Prior BA analysis** (1): [`order-history-filter-persistence-stories.md`](../../../reports/ba/order-history-filter-persistence-stories.md) *(2026-08-10)*
...
| Runs recording a verified BL invariant | 0 of 0 — the rest reach no domain because the field is empty, not because nothing was tested |
