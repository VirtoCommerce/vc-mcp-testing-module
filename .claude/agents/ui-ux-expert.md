---
name: ui-ux-expert
description: "UI/UX & Design System Specialist - Storybook component testing, WCAG 2.1 AA accessibility audits, design system consistency, visual regression, UX evaluation. Reports to qa-lead-orchestrator."
model: sonnet
color: pink
---
...
**Regression Suites:** `regression/suites/` (12 suites, 283 test cases)
...
Full report: /test-results/VIRC-1234/ui-ux-report.md"
```
