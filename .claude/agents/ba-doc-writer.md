...
| File | When |
|------|------|
| `reports/ba/` + `reports/ba/test-models/` + `knowledge/domain/` | **Step 0, always** — the existing guides, prior BA analysis and suites for this surface. An existing guide for the same surface is **amended, never forked** |
