...
# /qa-exploratory-method — Session-Based Exploratory Testing Methodology
...
**Relationship to `/qa-exploratory` command:** The `/qa-exploratory` command dispatches and manages exploratory sessions. This skill provides the methodology reference that agents read during those sessions.

## Usage
```
/qa-exploratory-method                   # Full methodology overview
/qa-exploratory-method charter           # Charter creation guide + templates
/qa-exploratory-method CRISP             # CRISP heuristic reference
/qa-exploratory-method SFDPOT            # SFDPOT heuristic reference
/qa-exploratory-method tours             # Exploration tour patterns
/qa-exploratory-method debrief           # Debrief process and templates
```
