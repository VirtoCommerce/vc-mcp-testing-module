...
Use the module-to-suite mapping in `agents/knowledge/execution/module-suite-map.md` to identify which regression suites cover each changed module. If a change spans multiple modules, include all affected suites.
