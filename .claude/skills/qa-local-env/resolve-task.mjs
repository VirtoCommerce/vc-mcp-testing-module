...
async function main() {
  ...
  if (o.json) {
    ...
    if (verifyFlags.length) {
      console.log(`  verify loaded      : node skills/qa-local-env/healthcheck.mjs --token --password 'Password1!' ${verifyFlags.join(" ")}`);
