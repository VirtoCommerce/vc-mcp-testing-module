...
> **Terminal command:** `/qa-design <component | page | flow>` — see [.claude/commands/qa-design.md](../../../commands/qa-design.md). The command parses the argument, resolves audit scope from [critical-ui-scope.md](../../../agents/knowledge/oracles/critical-ui-scope.md), and dispatches `ui-ux-expert`; this file is the methodology library it consults.
