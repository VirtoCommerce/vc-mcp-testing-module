...
> Bug report **templates** are in `skills/qa-defect/defect-report-templates.md`. This file covers the investigation **process** before the report. For the full defect lifecycle (triage, classification, verification), see `skills/qa-defect/defect-lifecycle-workflow.md`.
...
Resolve the **exact** module name via `.claude/knowledge/execution/module-suite-map.md` (Module → REST path →
...
| Admin SPA section | Check `.claude/knowledge/execution/module-suite-map.md` |
