...
//
// Usage:
//   node skills/run-vc-mcp-testing-module/driver.mjs            # run all checks
//   node skills/run-vc-mcp-testing-module/driver.mjs --list     # list checks, don't run
//   node skills/run-vc-mcp-testing-module/driver.mjs td scope   # run only matching checks
//
...
const REPO = resolve(SKILL_DIR, "..", "..", ".."); // <repo>/skills/run-.. → <repo>
