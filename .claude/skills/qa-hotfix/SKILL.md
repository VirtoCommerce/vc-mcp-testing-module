...
- Report per bundle: new patch version + release URL. Comment the outcome on the JIRA task (English; Markdown, never Jira wiki markup; outcome-first per `.claude/knowledge/execution/tracker-ops.md` §5a **Comment & body style**).
