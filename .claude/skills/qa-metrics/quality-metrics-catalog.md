...
The project has 36 regression suites (15 frontend + 21 backend) defined in `config/test-suites.json` with CSV files in `regression/suites/`. Coverage is measured against the E2E scenario catalog in `skills/qa-plan/e2e-scenario-catalog.md`.
