...
Evaluated before production release. Covers all 123 regression suites (56 frontend + 67 backend).

| Criterion | Threshold | Measurement |
|-----------|-----------|-------------|
| Overall pass rate | >=98% | Combined pass rate across all 123 suites |
...
**Notes:**
- Full release gate requires execution of all 123 suites. Partial execution does not satisfy the gate.
...
**Notes:**
- Hotfix gate does not require full regression (123 suites). Only the affected area plus smoke.
