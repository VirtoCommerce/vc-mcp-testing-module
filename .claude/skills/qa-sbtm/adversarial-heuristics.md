...
- `knowledge/oracles/vc-bug-catalog.md` — VC historical failure patterns (feeds Bad Neighborhood Tour + Familiar Problems oracle)
- `knowledge/oracles/e-commerce-edge-cases-library.md` — Generic e-commerce ECL-* patterns
