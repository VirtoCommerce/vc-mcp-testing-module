...
- `.claude/rules/reports.md` — Report file policy + brevity rule: 5 allowed categories (bug, test cases, BA, regression, monitoring), hard size caps per type (bug <150 lines, clean regression <30, BA <250), bloat patterns to cut, reference-don't-inline
