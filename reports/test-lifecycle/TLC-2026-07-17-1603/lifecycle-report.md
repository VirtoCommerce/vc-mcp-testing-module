...
1. **D2 — dev confirm:** `address.regionName` returns the region **code** ("NY") not the name. SR-GQL-036/039 + `ORG_ACME.regionName` alias currently expect the name (retarget to `region_id` is ready pending 1-line confirm).
