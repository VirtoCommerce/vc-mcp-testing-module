...
**JIRA:** [VCST-5110](https://virtocommerce.atlassian.net/browse/VCST-5110) — transitioned to **Done** (resolution: Done) on 2026-05-20T14:04
...
Skeleton placeholder height aligned to final rendered list-card height so the swap no longer produces a layout shift. Expected post-fix: CLS ≤ 0.10 at 375 px (was 0.483, P0 — 5× budget) and at 768 px (was 0.137).

---

## Status (historical): READY_TO_SUBMIT (filed as VCST-5110)
